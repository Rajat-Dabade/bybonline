	...
	<div class="row">
		...
		<div class="container">
			<div class="col-md-4">
				<div width="300">
				    <div class="hovereffect">
				        <img class="img-responsive" src="images/cookie/cookies6.jpg" alt="">
			            <div class="overlay">
			                <h2>Cookies</h2>
							<table class="table">
									<tr>
			...
			<div class="col-md-4">
				<div width="300">
				    <div class="hovereffect">
				        <img class="img-responsive" src="images/cookie/cookies.jpg" alt="">
			            <div class="overlay">
			                <h2>cookies</h2>
							<table class="table">
									<tr>
			...
			<div class="col-md-4">
				<div width="300">
				    <div class="hovereffect">
				        <img class="img-responsive" src="images/cookie/cookies2.jpg" alt="">
			            <div class="overlay">
			                <h2>cookies</h2>						
							<table class="table">
									<tr>
		...
		<div class="container">
			<div class="col-md-4">
				<div width="300">
				    <div class="hovereffect">
				        <img class="img-responsive" src="images/cookie/cookies3.jpg" alt="">
			            <div class="overlay">
			                <h2>cookies</h2>
							<table class="table">
									<tr>
			...
			<div class="col-md-4">
				<div width="300">
				    <div class="hovereffect">
				        <img class="img-responsive" src="images/cookie/cookies4.jpg" alt="">
			            <div class="overlay">
			                <h2>cookies</h2>
							<table class="table">
									<tr>
			...
			<div class="col-md-4">
				<div width="300">
				    <div class="hovereffect">
				        <img class="img-responsive" src="images/cookie/cookies5.jpg" alt="">
			            <div class="overlay">
			                <h2>cookies</h2>						
							<table class="table">
									<tr>
