		...
		<div class="container">
			...
			<div id="filters">
				...
				<div class="col-lg-3 col-md-6 col-sm-12">
					...
					<input width="400" type="range" id="range" min="0" max="1499" name="sld3" value="0" onchange="show_value(this.value);">2499
				</div>
				<div class="col-lg-3 col-md-6 col-sm-12">
				...
				<div class="col-lg-3 col-md-6 col-sm-12">
					<input type="submit" name="submit" value="Submit" onclick="filterCookie()"><br>
