		...
		<div class="container">
			...
			<div id="filters">
				...
				<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12">
					...
					<input type="radio" id="s1" name="shape" value="rectangle">&nbsp;Rectangle <br>
					<input type="radio" id="s2" name="shape" value="square">&nbsp;Square <br>
					<input type="radio" id="s3" name="shape" value="circle">&nbsp;Circle <br>
					<input type="radio" id="s4" name="shape" value="heart">&nbsp;Heart <br>
				</div>
				<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12">
				...
				<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12">
					...
					<input width="400" type="range" id="range" min="0" max="1499" name="sld3" value="0" onchange="show_value(this.value);">1499
				</div>
				<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12">
					<p class="filter-title">Weight: </p><br>
					<input type="radio" id="w1" name="weight" value="0.5">&nbsp;0.5 kg <br>
					<input type="radio" id="w2" name="weight" value="1">&nbsp;1 kg <br>
					<input type="radio" id="w3" name="weight" value="2">&nbsp;2 kg <br>
					<input type="radio" id="w4" name="weight" value="3">&nbsp;3 kg <br>
				</div>
				<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12">
				<input type="submit" name="submit" value="Submit" onclick="filterCake()"><br>
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div width="300">
				    <div class="hovereffect">
				        <img class="img-responsive" src="<?php echo $image; ?>" alt="" style="padding: 5%;">
			            <div class="overlay">
			                <h2><?php echo $name; ?></h2>
							<table class="table">
								<tr>
								...
								<tr>
									<th>Ingredient:</th>
									<td><?php $ingredients; ?></td>
								</tr>
							</table>
							<a href="addtocart.php?value=cake&productId=<?php echo $productId; ?>&price=<?php echo $price?>" style="color: #444;font-weight: bold;" class="addtocart">Add to Cart</a>
			            </div>
				    </div>
				</div>
			</div>
