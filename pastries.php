		...
		<div class="container">
			...
			<div id="filters">
				...
				<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12">
					...
					<input type="radio" id="s2" name="shape" value="circle">&nbsp;Circle <br>
					<input type="radio" id="s3" name="shape" value="heart">&nbsp;Heart <br>
				</div>
				<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12">
					<p class="filter-title">Flavor: </p><br>
					<input type="radio" name="flavor" value="blackforest">&nbsp;Black forest <br>
					<input type="radio" name="flavor" value="pineapple">&nbsp;Pineapple <br>
					<input type="radio" name="flavor" value="redvelvet">&nbsp;Red velvet <br>
					<input type="radio" name="flavor" value="fruit">&nbsp;Fruit pastries <br>
				</div>
				<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12">
					<p class="filter-title">Price range: </p><br>
					<span id="slider_value" style="color:black;text-align: center">0</span>
					<input width="400" id="range" type="range" min="0" max="499" name="sld3" value="199" onchange="show_value(this.value);">499
				</div>
				<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12">
					<p class="filter-title">Veg: </p><br>
					<input type="radio" id="v1" name="veg" value="yes">&nbsp;Yes <br>
					<input type="radio" id="v2" name="veg" value="no">&nbsp;No <br>
				</div>
				<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12">
					<input type="submit" name="submit" value="Submit" onclick="filterPastry()"><br>
