	...
	<div class="row">
		...
		<div class="container">
			<div class="col-md-4">
				<div width="300">
				    <div class="hovereffect">
				        <img class="img-responsive" src="images/bread/bread3.jpg" alt="">
			            <div class="overlay">
			                <h2>bread</h2>
							<table class="table">
									<tr>
			...
			<div class="col-md-4">
				<div width="300">
				    <div class="hovereffect">
				        <img class="img-responsive" src="images/bread/bread2.jpg" alt="">
			            <div class="overlay">
			                <h2>bread</h2>
							<table class="table">
									<tr>
			...
			<div class="col-md-4">
				<div width="300">
				    <div class="hovereffect">
				        <img class="img-responsive" src="images/bread/bread.jpg" alt="">
			            <div class="overlay">
			                <h2>bread</h2>						
							<table class="table">
									<tr>
